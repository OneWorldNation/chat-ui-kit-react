...
declare const MessageHtmlContent: (
  props: ChatComponentProps<MessageHtmlContentProps, "div">
) => ReactElement;
...
declare const MessageImageContent: (
  props: ChatComponentProps<MessageImageContentProps, "div">
) => ReactElement;
...
declare const MessageTextContent: (
  props: ChatComponentPropsChildren<MessageTextContentProps, "div">
) => ReactElement;
...
declare const MessageHeader: (
  props: ChatComponentPropsChildren<MessageHeaderProps, "div">
) => ReactElement;
...
declare const MessageFooter: (
  props: ChatComponentPropsChildren<MessageFooterProps, "div">
) => ReactElement;
